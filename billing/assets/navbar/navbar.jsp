  ...
  <div class="sidebar-menu">
    ...
    <div class="sidebar-dropdown">
      ...
      <div class="collapse sidebar-submenu" id="productMenu">
        ...
        <a href="<%=request.getContextPath()%>/product/master/stock/stock.jsp" class="sidebar-subitem">Stock Management</a>        <a href="<%=request.getContextPath()%>/product/master/customer/page.jsp" class="sidebar-subitem">Customers</a>
        <!-- Customer Submenu -->
      ...
      <div class="collapse sidebar-submenu" id="accountReportMenu">
        ...
        <div class="sidebar-submenu-item">
          ...
          <div class="collapse sidebar-submenu" id="collectionReportMenu">
            ...
            <a href="<%=request.getContextPath()%>/reports/attenderSales/page.jsp" class="sidebar-subitem"><i class="fas fa-user-tie me-2"></i>Sales by Attender</a>
    ...
    <div class="sidebar-dropdown">
      ...
      <div class="collapse sidebar-submenu" id="adminMenu">
        ...
        <a href="<%=request.getContextPath()%>/admin/attender/page.jsp" class="sidebar-subitem"><i class="fas fa-user-tie me-2"></i>Attender Management</a>
