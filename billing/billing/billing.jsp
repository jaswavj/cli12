                        ...
                        <div class="card flex-shrink-0 my-1">
                            <div class="card-body">
                                ...
                                <div class="row g-1 mb-1">
                                    ...
                                    <!--div class="col-2">
                                        <button class="btn btn-outline-primary btn-sm w-100" onclick="window.location.href='../cafeOrder/order/page.jsp'">
                                            <i class="fa-solid fa-plus"></i> NEW ORDER
                                        </button>
                                    </div>
                                    <div class="col-2">
                                        <button class="btn btn-outline-success btn-sm w-100" onclick="showOrderList()">
                                            <i class="fa-solid fa-utensils"></i> BILL ORDER
                                        </button>
                                    </div>
                                    <div class="col-3">
                                        <button class="btn btn-outline-violet btn-sm w-100" data-bs-toggle="modal" data-bs-target="#quotationListModal">
                                            <i class="fa-solid fa-file-invoice"></i> QUOTATION LIST
                                        </button>
                                    </div-->
                                ...
                                <div class="row g-1 mb-1">
                                    ...
                                    <div class="col-6 col-md-4 col-lg">
                                        ...
                                        <div class="row g-2 mt-1">
                                            ...
                                            <!--div class="col-12 col-md-6 col-lg">
                                                <button class="btn btn-outline-secondary btn-sm w-100" onclick="previewBill()" title="Open print preview in browser">
                                                    <i class="fa-solid fa-eye"></i> PREVIEW
                                                </button>
                                            </div>

                                            <div class="col-12 col-md-6 col-lg">
                                                <button class="btn btn-outline-violet btn-sm w-100" onclick="printQuotation()">
                                                    <i class="fa-solid fa-file-invoice"></i> QUOTATION
                                                </button>
                                            </div-->
