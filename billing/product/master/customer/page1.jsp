...
String salesmanParam = request.getParameter("salesman");
...
int salesman = (salesmanParam != null && !salesmanParam.isEmpty()) ? Integer.parseInt(salesmanParam) : 0;
int area = (areaParam != null && !areaParam.isEmpty()) ? Integer.parseInt(areaParam) : 0;
double creditLimit = (creditLimitParam != null && !creditLimitParam.isEmpty()) ? Double.parseDouble(creditLimitParam) : 0.0;
