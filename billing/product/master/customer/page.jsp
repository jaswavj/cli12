...
<% } %>
    ...
    <div class="container mt-4 ">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<%=contextPath%>/product/master/customer/page1.jsp" method="post" class="row g-3">
                    <div class="col-md-6 input-outline">
                        <input type="text" name="custName" class="form-control" placeholder="" required><label >Customer Name</label>
                    </div>
                    <div class="col-md-6 input-outline">
                        <input type="number" name="custPhn" class="form-control" placeholder="" ><label >Phone Number</label>
                    </div>
                    ...
                    <div class="col-md-6 input-outline">
                        <select name="salesman" class="form-control">
                            ...
                            %>
                            <option value="<%=smId%>"><%=smName%></option>
                            <% } %>
                        </select>
                    ...
                    <div class="col-md-6 input-outline">
                        <select name="area" class="form-control">
                            ...
                            %>
                            <option value="<%=arId%>"><%=arName%></option>
                            <% } %>
                        </select>
                    ...
                    <div class="col-md-6 input-outline">
                        <input type="number" name="creditLimit" class="form-control" placeholder="" step="0.001" value="0">
                        <label>Credit Limit</label>
                    </div>
                    
                    <div class="col-md-6 input-outline">
                        <textarea name="custAddress" class="form-control" placeholder="Address" rows="3"></textarea>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
                            ...
                            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem;">
                                <a href="<%=contextPath%>/product/master/customer/edit.jsp?Name=<%=Name%>&id=<%=id%>&address=<%=address%>&phn=<%=phn%>&gstin=<%=gstin%>" class="btn btn-warning btn-sm btn-edit">Edit</a>
