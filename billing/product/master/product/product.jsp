                        ...
                        <table class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0; font-size: 0.85rem; table-layout: fixed; width: 100%; min-width: 600px;">
                            <thead style="background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%); position: sticky; top: 0; z-index: 10;">
                                <tr>
                                    ...
                                    <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.8rem; width: 20%;">Name</th>
                                    ...
                                    <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; text-align: center; border: none; font-size: 0.8rem; width: 5%;">Action</th>
                                </tr>
                            </thead>
        ...
        data.products.forEach(product => {
            html += `
                <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
                    ...
                    <td style="padding: 0.4rem; color: #2d3748; font-weight: 500; border: none; width: 20%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="${product.productName}">${product.productName}</td>
                    ...
                    <td style="padding: 0.4rem; text-align: center; border: none; width: 5%;">
